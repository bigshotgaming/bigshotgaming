...
# FORUM Settings
FORUM_BASE_TITLE = get('DJANGOBB_FORUM_BASE_TITLE', 'Big Shot Gaming Forums')
...
DEFAULT_TIME_ZONE = get('DJANGOBB_DEFAULT_TIME_ZONE', -5)
...
HEADER = get('DJANGOBB_HEADER', 'Big Shot Gaming')
TAGLINE = get('DJANGOBB_TAGLINE', "Central Michigan University's own LAN gaming group")
