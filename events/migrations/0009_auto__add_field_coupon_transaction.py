...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.transaction'
        db.add_column('events_coupon', 'transaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ipn.PayPalIPN'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.transaction'
        db.delete_column('events_coupon', 'transaction_id')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c661397d-149c-4393-a5b7-947e5ec32b9d'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
