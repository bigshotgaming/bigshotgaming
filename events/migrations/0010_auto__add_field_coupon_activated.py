...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.activated'
        db.add_column('events_coupon', 'activated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.activated'
        db.delete_column('events_coupon', 'activated')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'edc3479b-579c-4381-bd2a-204b67f44126'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
