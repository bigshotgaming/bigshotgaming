...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_participant', 'coupon', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['events.Coupon'], unique=True, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('events_ticket', (
            ('coupon', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['events.Coupon'], unique=True, null=True)),
        ...
        db.delete_column('events_participant', 'coupon_id')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'018f42f1-7fdf-42b7-8844-07836d8dab8c'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
