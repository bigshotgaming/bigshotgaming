...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.signup_time'
        db.add_column('events_participant', 'signup_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 9, 11, 20, 42, 22, 39513), blank=True), keep_default=False)

        # Adding field 'Coupon.created_time'
        db.add_column('events_coupon', 'created_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 9, 11, 20, 42, 27, 303334), blank=True), keep_default=False)

        # Adding field 'Coupon.activated_time'
        db.add_column('events_coupon', 'activated_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.signup_time'
        db.delete_column('events_participant', 'signup_time')

        # Deleting field 'Coupon.created_time'
        db.delete_column('events_coupon', 'created_time')

        # Deleting field 'Coupon.activated_time'
        db.delete_column('events_coupon', 'activated_time')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5a14b6f2-de4e-4f12-9bc3-9d4eb4440678'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
