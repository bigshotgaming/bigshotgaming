...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.checkin_time'
        db.add_column('events_participant', 'checkin_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.checkin_time'
        db.delete_column('events_participant', 'checkin_time')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b61a4d6b-36b7-4b10-afcd-9917e0ce1195'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
