...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.checked_in'
        db.add_column('events_participant', 'checked_in', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.checked_in'
        db.delete_column('events_participant', 'checked_in')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e75166b6-9ee3-4de9-ba0f-80505216e000'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
