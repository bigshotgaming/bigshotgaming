...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.notes'
        db.add_column('events_coupon', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.notes'
        db.delete_column('events_coupon', 'notes')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'13ea937c-1ea4-431b-bd32-79752883a3c2'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
