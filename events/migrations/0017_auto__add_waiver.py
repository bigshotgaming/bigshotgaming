...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Waiver'
        db.create_table('events_waiver', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('part', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Participant'])),
            ...
            ('pname', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('psig', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('minor', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('minor_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('minor_age', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('signed_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('events', ['Waiver'])


    def backwards(self, orm):
        
        # Deleting model 'Waiver'
        db.delete_table('events_waiver')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d726e748-3a71-435d-9ac3-92e59843b628'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
        ...
        'events.waiver': {
            ...
            'minor_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'psig': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
