...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Waiver.psig'
        db.delete_column('events_waiver', 'psig')

        # Deleting field 'Waiver.minor_name'
        db.delete_column('events_waiver', 'minor_name')

        # Deleting field 'Waiver.alias'
        db.delete_column('events_waiver', 'alias')

        # Deleting field 'Waiver.signature'
        db.delete_column('events_waiver', 'signature')


    def backwards(self, orm):
        
        # Adding field 'Waiver.psig'
        db.add_column('events_waiver', 'psig', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Waiver.minor_name'
        db.add_column('events_waiver', 'minor_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Waiver.alias'
        db.add_column('events_waiver', 'alias', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Waiver.signature'
        db.add_column('events_waiver', 'signature', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'89b237ff-2ea8-4a73-ad3a-47962c6aeb6d'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
        ...
        'events.waiver': {
            ...
            'part': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.Participant']"}),
