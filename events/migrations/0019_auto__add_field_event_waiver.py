...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.waiver'
        db.add_column('events_event', 'waiver', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.waiver'
        db.delete_column('events_event', 'waiver')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6feb12cb-8dda-476a-8d71-46b8bcc9b0e2'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
