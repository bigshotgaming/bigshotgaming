...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Prize.event'
        db.delete_column('sponsorship_prize', 'event_id')

        # Deleting field 'Prize.sponsor'
        db.delete_column('sponsorship_prize', 'sponsor_id')

        # Adding field 'Prize.eventsponsor'
        db.add_column('sponsorship_prize', 'eventsponsor', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sponsorship.EventSponsor']), keep_default=False)
