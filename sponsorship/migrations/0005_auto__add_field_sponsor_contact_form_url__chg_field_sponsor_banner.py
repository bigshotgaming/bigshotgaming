...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sponsor.contact_form_url'
        db.add_column('sponsorship_sponsor', 'contact_form_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Changing field 'Sponsor.banner'
        db.alter_column('sponsorship_sponsor', 'banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100))


    def backwards(self, orm):
        
        # Deleting field 'Sponsor.contact_form_url'
        db.delete_column('sponsorship_sponsor', 'contact_form_url')

        # Changing field 'Sponsor.banner'
        db.alter_column('sponsorship_sponsor', 'banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
