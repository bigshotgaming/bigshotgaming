...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('sponsorship_sponsor', 'url')

        # Adding field 'Sponsor.banner_url'
        db.add_column('sponsorship_sponsor', 'banner_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sponsor.banner_url'
        db.delete_column('sponsorship_sponsor', 'banner_url')
