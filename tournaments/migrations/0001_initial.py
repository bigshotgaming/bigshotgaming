...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tournaments_team_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm['tournaments.team'], null=False)),
            ('participant', models.ForeignKey(orm['events.participant'], null=False))
        ))
        db.create_unique('tournaments_team_members', ['team_id', 'participant_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tournaments_team_members')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'668d8fc5-449b-4f20-b865-6931d1741ddd'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
