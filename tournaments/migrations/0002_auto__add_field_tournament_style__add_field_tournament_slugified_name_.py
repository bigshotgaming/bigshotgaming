...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tournaments_tournament', 'style', self.gf('django.db.models.fields.CharField')(default='S', max_length=1), keep_default=False)

        # Adding field 'Tournament.slugified_name'
        db.add_column('tournaments_tournament', 'slugified_name', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)

        # Adding field 'Tournament.is_active'
        db.add_column('tournaments_tournament', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Tournament.has_started'
        db.add_column('tournaments_tournament', 'has_started', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tournament.style'
        db.delete_column('tournaments_tournament', 'style')

        # Deleting field 'Tournament.slugified_name'
        db.delete_column('tournaments_tournament', 'slugified_name')

        # Deleting field 'Tournament.is_active'
        db.delete_column('tournaments_tournament', 'is_active')

        # Deleting field 'Tournament.has_started'
        db.delete_column('tournaments_tournament', 'has_started')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a15a8175-e1e2-40c0-9a8f-5a3a46f6da1e'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
        ...
        'tournaments.tournament': {
            ...
            'slugified_name': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
