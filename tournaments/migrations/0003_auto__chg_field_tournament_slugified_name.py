...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tournament.slugified_name'
        db.alter_column('tournaments_tournament', 'slugified_name', self.gf('django.db.models.fields.SlugField')(max_length=80))


    def backwards(self, orm):
        
        # Changing field 'Tournament.slugified_name'
        db.alter_column('tournaments_tournament', 'slugified_name', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8d1e110c-08fc-46cb-b5a3-0e6b677e681a'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
