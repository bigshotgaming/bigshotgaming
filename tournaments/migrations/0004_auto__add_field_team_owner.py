...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tournaments_team', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='owned_by', to=orm['events.Participant']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Team.owner'
        db.delete_column('tournaments_team', 'owner_id')
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1e404dc6-1214-42e4-874a-335a7722465d'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
