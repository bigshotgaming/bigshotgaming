...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tournament.html_rules'
        db.add_column('tournaments_tournament', 'html_rules', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'Tournament.rules'
        db.alter_column('tournaments_tournament', 'rules', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Tournament.html_rules'
        db.delete_column('tournaments_tournament', 'html_rules')

        # Changing field 'Tournament.rules'
        db.alter_column('tournaments_tournament', 'rules', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'events.coupon': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6eb59030-d7ef-4db9-a4f6-d4d46431f652'", 'max_length': '36', 'primary_key': 'True'})
        },
        'events.event': {
